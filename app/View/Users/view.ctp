    ...
    <table class="table table-striped">
        <tbody>
            ...
            <tr>
                ...
                <td class="data"><?= $user['User']['telefone'] ?></td>
            </tr>
            <tr>
                <td class="dlabel">Curso:</td>
                <td class="data"><?= $user['Curso']['name'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="dlabel">Data de Cadastro:</td>
                <td class="data"><?php $user['User']['created'] ? print $this->FrontEnd->niceDate($user['User']['last_login'], true) : print 'Data não registrada' ?></td>
            </tr>
            <tr>
                <td class="dlabel">Última atualização:</td>
                <td class="data"><?php $user['User']['created'] ? print $this->FrontEnd->niceDate($user['User']['last_login'], true) : print 'Cadastro não editado' ?></td>
            </tr>
        </tbody>
    </table>
</div>

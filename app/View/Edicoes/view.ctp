<div class="form-horizontal view">
	<div class="row-fluid title">
		...
		<div class="span2">
		<?php
			print $this->Html->link( '<i class="icon-trash icon-white"></i> Excluir', "/edicoes/delete/{$edicoes['Edicao']['cod_edicao']}", array( 'class' => 'btn btn-mini btn-danger delete', 'escape' => false ) );
			print $this->Html->link( '<i class="icon-edit"></i> Editar', "/edicoes/edit/{$edicoes['Edicao']['cod_edicao']}", array( 'class' => 'btn btn-mini', 'escape' => false ) );
		?>
		</div>
	</div>
